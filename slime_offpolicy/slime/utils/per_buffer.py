...
- Priority p_i = (|advantage_i| + eps)^alpha  (per group; default source = |advantage|)
...
class PrioritizedReplayStrategy(BaseSamplingStrategy):
    ...
    Configuration (all via args):
        ...
        --per-priority-source        advantage  advantage|reward|reward_dev
    ...
    def __init__(self, args, current_policy_version):
        ...
        self.priority_source = str(getattr(args, "per_priority_source", "advantage"))
