...
#
# This is a thin wrapper over the existing Qwen3-8B terminal-rl launcher. It
# injects replay/off-policy algorithm flags through EXTRA_ALGO_ARGS and uses the
# integrated slime backend by default.
#
# Examples:
...
BASE_SCRIPT="${BASE_SCRIPT:-${SCRIPT_DIR}/terminal-rl_qwen3-8b_pu.sh}"
